                            ...
                            <div tabindex="-1" role="menu" aria-hidden="true"
                                ...
                                <div class="scroll-area-xs" style="height: 150px;">
                                    <div class="scrollbar-container ps">
                                        <ul class="nav flex-column">
                                            <li class="nav-item-header nav-item">Information
                                            </li>
                                            <li class="nav-item-header nav-item">Email: {{ Auth::user()->email }}</li>
                                            <li class="nav-item-header nav-item">Name: {{ Auth::user()->name }}</li>
                                            <li class="nav-item-header nav-item">Gender: {{ Auth::user()->gender }}</li>
